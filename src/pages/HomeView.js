  ...
  return (
    <React.Fragment>
      ...
      <div className="container contenSliderHome">
        <h1 className="fw-3 fs-2 TitleHome mb-4">Bienestar Estudiantil</h1>
      ...
      <div id="Notices" className="container mt-2 contentNew">
        <div className="row">
          <div className="col-xl-6">
            <h1 className="fw-3 fs-2 TitleHome mb-4 mt-3">Anuncios</h1>
      ...
      <div className="container contenSliderHome">
        <h1 className="fw-3 fs-2 TitleHome mb-4">Galería</h1>
