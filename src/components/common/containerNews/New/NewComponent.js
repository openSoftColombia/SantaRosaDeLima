...
const NewComponent = () => {
  ...
  let news = [{
    ...
    description: 'Hola',
    publications: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eget ligula vitae diam vehicula imperdiet ut vel ligula. Cras viverra ex in erat facilisis, id blandit dui volutpat. ',
    img: [{
      src: 'https://images.pexels.com/photos/5088180/pexels-photo-5088180.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'
    }]
  }]
